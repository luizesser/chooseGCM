...
For the first part of this Rmarkdown, we will import data for the study area.

```{r study_area_parana}
study_area_parana <- geodata::gadm(country = "Brazil", returnclass = "sv", path="input_data/")
study_area_parana <- subset(study_area_parana, study_area_parana$NAME_1 == "Paraná")
study_area_parana |> plot()
```
