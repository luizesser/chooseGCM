...
# How chooseGCM changes with increasing area?
...
mc_hclust_50
hclust_50 <- mc_hclust_50$suggested_gcms$k5
tictoc::toc()
```
...
mc_hclust_100 <- montecarlo_gcms(s10, 
                             ...
                             clustering_method = "hclust")
mc_hclust_100
hclust_100 <- mc_hclust_100$suggested_gcms$k5
tictoc::toc()
```
...
mc_hclust_150 <- montecarlo_gcms(s10, 
                             ...
                             clustering_method = "hclust")
mc_hclust_150
hclust_150 <- mc_hclust_150$suggested_gcms$k5
tictoc::toc()
```
...
mc_hclust_200 <- montecarlo_gcms(s10, 
                             ...
                             clustering_method = "hclust")
mc_hclust_200
hclust_200 <- mc_hclust_200$suggested_gcms$k5
tictoc::toc()
```
...
mc_hclust_250 <- montecarlo_gcms(s10, 
                             ...
                             clustering_method = "hclust")
mc_hclust_250
hclust_250 <- mc_hclust_250$suggested_gcms$k5
tictoc::toc()
```
...
mc_hclust_300 <- montecarlo_gcms(s10, 
                             ...
                             clustering_method = "hclust")
mc_hclust_300
hclust_300 <- mc_hclust_300$suggested_gcms$k5
tictoc::toc()
```
...
mc_hclust_350 <- montecarlo_gcms(s10, 
                             ...
                             clustering_method = "hclust")
mc_hclust_350
hclust_350 <- mc_hclust_350$suggested_gcms$k5
tictoc::toc()
```
...
mc_hclust_400 <- montecarlo_gcms(s10, 
                             ...
                             clustering_method = "hclust")
mc_hclust_400
hclust_400 <- mc_hclust_400$suggested_gcms$k5
tictoc::toc()
```
...
mc_hclust_450 <- montecarlo_gcms(s10, 
                             ...
                             clustering_method = "hclust")
mc_hclust_450
hclust_450 <- mc_hclust_450$suggested_gcms$k5
tictoc::toc()
```
...
mc_hclust_500 <- montecarlo_gcms(s10, 
                             ...
                             clustering_method = "hclust")
mc_hclust_500
hclust_500 <- mc_hclust_500$suggested_gcms$k5
tictoc::toc()
```
...
mc_kmeans_50
kmeans_50 <- mc_kmeans_50$suggested_gcms$k5
tictoc::toc()
```
...
mc_kmeans_100 <- montecarlo_gcms(s10, 
                             ...
                             clustering_method = "kmeans")
mc_kmeans_100
kmeans_100 <- mc_kmeans_100$suggested_gcms$k5
tictoc::toc()
```
...
mc_kmeans_150 <- montecarlo_gcms(s10, 
                             ...
                             clustering_method = "kmeans")
mc_kmeans_150
kmeans_150 <- mc_kmeans_150$suggested_gcms$k5
tictoc::toc()
```
...
mc_kmeans_200 <- montecarlo_gcms(s10, 
                             ...
                             clustering_method = "kmeans")
mc_kmeans_200
kmeans_200 <- mc_kmeans_200$suggested_gcms$k5
tictoc::toc()
```
...
mc_kmeans_250 <- montecarlo_gcms(s10, 
                             ...
                             clustering_method = "kmeans")
mc_kmeans_250
kmeans_250 <- mc_kmeans_250$suggested_gcms$k5
tictoc::toc()
```
...
mc_kmeans_300 <- montecarlo_gcms(s10, 
                             ...
                             clustering_method = "kmeans")
mc_kmeans_300
kmeans_300 <- mc_kmeans_300$suggested_gcms$k5
tictoc::toc()
```
...
mc_kmeans_350 <- montecarlo_gcms(s10, 
                             ...
                             clustering_method = "kmeans")
mc_kmeans_350
kmeans_350 <- mc_kmeans_350$suggested_gcms$k5
tictoc::toc()
```
...
mc_kmeans_400 <- montecarlo_gcms(s10, 
                             ...
                             clustering_method = "kmeans")
mc_kmeans_400
kmeans_400 <- mc_kmeans_400$suggested_gcms$k5
tictoc::toc()
```
...
mc_kmeans_450 <- montecarlo_gcms(s10, 
                             ...
                             clustering_method = "kmeans")
mc_kmeans_450
kmeans_450 <- mc_kmeans_450$suggested_gcms$k5
tictoc::toc()
```
...
mc_kmeans_500 <- montecarlo_gcms(s10, 
                             ...
                             clustering_method = "kmeans")
mc_kmeans_500
kmeans_500 <- mc_kmeans_500$suggested_gcms$k5
tictoc::toc()
```
